...
wpotis_acf_gutenberg_display_admin_default_carousel( $block );
...
if ( have_rows( 'carousel_slides' ) ) :
	...
	while ( have_rows( 'carousel_slides' ) ) :
		...
		$classname     = $color && wpotis_has_array_key( 'color_picker', $color ) ? 'has-font-color color-' . esc_attr( $color['color_picker'] ) : '';
