...
function wdsCustomizer() {
	const headerButtonSelect = document.querySelector( '#customize-control-wpotis_header_button select' );

	if ( ! headerButtonSelect ) {
		return;
	}

	const headerLinkButton = document.querySelector( '#customize-control-wpotis_header_button_url' ),
		headerLinkText = document.querySelector( '#customize-control-wpotis_header_button_text' );
