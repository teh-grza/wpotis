 ...
 */
function wpotis_remove_default_customizer_sections( $wp_customize ) {
...
add_action( 'customize_register', 'wpotis_remove_default_customizer_sections', 15 );
 ...
 * @author WDS
 */
function wpotis_include_custom_controls() {
...
add_action( 'customize_register', 'wpotis_include_custom_controls', -999 );
 ...
 * @author WDS
 */
function wpotis_customize_scripts() {
	wp_enqueue_script( 'wpotis-customize-livepreview', get_template_directory_uri() . '/inc/customizer/assets/scripts/livepreview.js', array( 'jquery', 'customize-preview' ), '1.0.0', true );
}
add_action( 'customize_preview_init', 'wpotis_customize_scripts' );
 ...
 */
function wpotis_selective_refresh_support( $wp_customize ) {

	// The <div> classname to append edit icon too.
	$settings = array(
		'blogname'          => '.site-title a',
		'blogdescription'   => '.site-description',
		'wpotis_copyright_text' => '.site-info',
	);
...
add_action( 'customize_register', 'wpotis_selective_refresh_support' );
 ...
 */
function wpotis_live_preview_support( $wp_customize ) {
...
add_action( 'customize_register', 'wpotis_live_preview_support', 999 );
