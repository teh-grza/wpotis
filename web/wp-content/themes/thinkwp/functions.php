 ...
 */
add_filter(
	'wp_otis_listings', function ( $params ) {
	$params['type'] = 'Regions';
	$params['set'] = 'toonly';
	return $params;
}
 ...
 */
function thinkwp_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'thinkwp' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'thinkwp' ),
...
add_action( 'widgets_init', 'thinkwp_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'thinkwp_scripts' );
